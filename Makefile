...
#    Updated: 2018/11/12 22:31:55 by albarret         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=ft_atoi.c ft_bzero.c ft_dup.c ft_isalnum.c \
	 ...
	 ft_isupper.c ft_itoa.c ft_lstadd.c ft_lstaddend.c \
...
OBJECTS=ft_atoi.o ft_bzero.o ft_dup.o ft_isalnum.o \
		ft_isalpha.o ft_isascii.o ft_isdigit.o ft_islower.o ft_isprint.o \
		ft_isupper.o ft_itoa.o ft_lstadd.o ft_lstaddend.o \
